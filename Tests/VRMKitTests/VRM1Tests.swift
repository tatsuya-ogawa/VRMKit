...
class VRM1Tests: XCTestCase {
    ...
    func testSpringBone() {
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.offset[0], -0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.offset[1], 0)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.offset[2], 0.02)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.tail[0], 0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.tail[1], 0)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.tail[2], 0.02)
        
        XCTAssertEqual(vrm.springBone?.colliders?[1].node, 5)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset[0], 0)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset[1], 0.02)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset[2], -0.07)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.offset[0], 0.065)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.offset[1], 0.14)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.offset[2], 0.01)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.tail[0], -0.065)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.tail[1], 0.14)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.tail[2], 0.01)
        
        XCTAssertEqual(vrm.springBone?.colliders?[3].node, 5)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset[0], 0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset[1], 0)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset[2], 0.02)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.tail[0], -0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.tail[1], 0)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.tail[2], 0.02)
        
        XCTAssertEqual(vrm.springBone?.colliders?[4].node, 130)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset[0], -0.004536999)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset[1], 7.566095e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset[2], 0.0127928918)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.tail[0], -0.001991607)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.tail[1], 0.329534262)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.tail[2], 0.009325488)
        
        XCTAssertEqual(vrm.springBone?.colliders?[5].node, 131)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset[0], 4.570225e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset[1], -1.477034e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset[2], 0.008859742)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.tail[0], 2.013798e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.tail[1], 0.3535266)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.tail[2], 0.008811156)
        
        XCTAssertEqual(vrm.springBone?.colliders?[6].node, 137)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset[0], 0.004536999)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset[1], 7.566095e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset[2], 0.0127928918)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.tail[0], 0.001991607)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.tail[1], 0.329534262)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.tail[2], 0.009325488)
        
        XCTAssertEqual(vrm.springBone?.colliders?[7].node, 138)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset[0], -4.57022464e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset[1], -1.477034e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset[2], 0.008859742)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.tail[0], -2.013798e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.tail[1], 0.3535266)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.tail[2], 0.008811156)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].gravityDir[1], -1)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir[2], 0)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir[0], 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir[1], -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir[2], 0)
    ...
    func testMaterialsMToon() {
        ...
        XCTAssertEqual(material0MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material0MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material0MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material0MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material0MToon?.outlineColorFactor?[0], 0)
        XCTAssertEqual(material0MToon?.outlineColorFactor?[1], 0)
        XCTAssertEqual(material0MToon?.outlineColorFactor?[2], 0)
        ...
        XCTAssertEqual(material0MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material0MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material0MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material0MToon?.shadeColorFactor?[0], 0.301212043)
        XCTAssertEqual(material0MToon?.shadeColorFactor?[1], 0.301212043)
        XCTAssertEqual(material0MToon?.shadeColorFactor?[2], 0.301212043)
        ...
        XCTAssertEqual(material1MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material1MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material1MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material1MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material1MToon?.outlineColorFactor?[0], 0.151317075)
        XCTAssertEqual(material1MToon?.outlineColorFactor?[1], 0.193065077)
        XCTAssertEqual(material1MToon?.outlineColorFactor?[2], 0.222877234)
        ...
        XCTAssertEqual(material1MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material1MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material1MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material1MToon?.shadeColorFactor?[0], 0.20541285)
        XCTAssertEqual(material1MToon?.shadeColorFactor?[1], 0.20541285)
        XCTAssertEqual(material1MToon?.shadeColorFactor?[2], 0.20541285)
        ...
        XCTAssertEqual(material2MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material2MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material2MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material2MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material2MToon?.outlineColorFactor?[0], 0.2411783)
        XCTAssertEqual(material2MToon?.outlineColorFactor?[1], 0.181807414)
        XCTAssertEqual(material2MToon?.outlineColorFactor?[2], 0.1557278)
        ...
        XCTAssertEqual(material2MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material2MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material2MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material2MToon?.shadeColorFactor?[0], 1)
        XCTAssertEqual(material2MToon?.shadeColorFactor?[1], 0.613979936)
        XCTAssertEqual(material2MToon?.shadeColorFactor?[2], 0.5079454)
        ...
        XCTAssertEqual(material3MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material3MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material3MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material3MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material3MToon?.outlineColorFactor?[0], 0)
        XCTAssertEqual(material3MToon?.outlineColorFactor?[1], 0)
        XCTAssertEqual(material3MToon?.outlineColorFactor?[2], 0)
        ...
        XCTAssertEqual(material3MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material3MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material3MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material3MToon?.shadeColorFactor?[0], 0.4352691)
        XCTAssertEqual(material3MToon?.shadeColorFactor?[1], 0.3970382)
        XCTAssertEqual(material3MToon?.shadeColorFactor?[2], 0.500747442)
        ...
        XCTAssertEqual(material4MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material4MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material4MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material4MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material4MToon?.outlineColorFactor?[0], 0)
        XCTAssertEqual(material4MToon?.outlineColorFactor?[1], 0)
        XCTAssertEqual(material4MToon?.outlineColorFactor?[2], 0)
        ...
        XCTAssertEqual(material4MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material4MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material4MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material4MToon?.shadeColorFactor?[0], 1)
        XCTAssertEqual(material4MToon?.shadeColorFactor?[1], 1)
        XCTAssertEqual(material4MToon?.shadeColorFactor?[2], 1)
        ...
        XCTAssertEqual(material5MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material5MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material5MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material5MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material5MToon?.outlineColorFactor?[0], 0)
        XCTAssertEqual(material5MToon?.outlineColorFactor?[1], 0)
        XCTAssertEqual(material5MToon?.outlineColorFactor?[2], 0)
        ...
        XCTAssertEqual(material5MToon?.parametricRimColorFactor?[0], 0.07896994)
        ...
        XCTAssertEqual(material5MToon?.shadeColorFactor?[0], 0.4352691)
        XCTAssertEqual(material5MToon?.shadeColorFactor?[1], 0.3970382)
        XCTAssertEqual(material5MToon?.shadeColorFactor?[2], 0.500747442)
        ...
        XCTAssertEqual(material6MToon?.matcapFactor?[0], 1)
        XCTAssertEqual(material6MToon?.matcapFactor?[1], 1)
        XCTAssertEqual(material6MToon?.matcapFactor?[2], 1)
        XCTAssertEqual(material6MToon?.matcapTexture?.index, 9)
        XCTAssertEqual(material6MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material6MToon?.outlineColorFactor?[0], 0.07896994)
        ...
        XCTAssertEqual(material6MToon?.parametricRimColorFactor?[0], 0.345616162)
        XCTAssertEqual(material6MToon?.parametricRimColorFactor?[1], 0.345616162)
        XCTAssertEqual(material6MToon?.parametricRimColorFactor?[2], 0.345616162)
        ...
        XCTAssertEqual(material6MToon?.shadeColorFactor?[0], 0.342953056)
        XCTAssertEqual(material6MToon?.shadeColorFactor?[1], 0.37243554)
        XCTAssertEqual(material6MToon?.shadeColorFactor?[2], 0.432035774)
        ...
        XCTAssertEqual(material8MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material8MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material8MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material8MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material8MToon?.outlineColorFactor?[0], 0.01850021)
        XCTAssertEqual(material8MToon?.outlineColorFactor?[1], 0.0176419467)
        XCTAssertEqual(material8MToon?.outlineColorFactor?[2], 0.0251868479)
        ...
        XCTAssertEqual(material8MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material8MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material8MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material8MToon?.shadeColorFactor?[0], 0.4352691)
        XCTAssertEqual(material8MToon?.shadeColorFactor?[1], 0.3970382)
        XCTAssertEqual(material8MToon?.shadeColorFactor?[2], 0.500747442)
        ...
        XCTAssertEqual(material10MToon?.matcapFactor?[0], 1)
        XCTAssertEqual(material10MToon?.matcapFactor?[1], 1)
        XCTAssertEqual(material10MToon?.matcapFactor?[2], 1)
        XCTAssertEqual(material10MToon?.matcapTexture?.index, 9)
        XCTAssertEqual(material10MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material10MToon?.outlineColorFactor?[0], 0.009166719)
        XCTAssertEqual(material10MToon?.outlineColorFactor?[1], 0.009166719)
        XCTAssertEqual(material10MToon?.outlineColorFactor?[2], 0.009166719)
        ...
        XCTAssertEqual(material10MToon?.parametricRimColorFactor?[0], 0.432035774)
        XCTAssertEqual(material10MToon?.parametricRimColorFactor?[1], 0.432035774)
        XCTAssertEqual(material10MToon?.parametricRimColorFactor?[2], 0.432035774)
        ...
        XCTAssertEqual(material10MToon?.shadeColorFactor?[0], 0.4352691)
        XCTAssertEqual(material10MToon?.shadeColorFactor?[1], 0.3970382)
        XCTAssertEqual(material10MToon?.shadeColorFactor?[2], 0.500747442)
        ...
        XCTAssertEqual(material11MToon?.matcapFactor?[0], 0)
        XCTAssertEqual(material11MToon?.matcapFactor?[1], 0)
        XCTAssertEqual(material11MToon?.matcapFactor?[2], 0)
        XCTAssertEqual(material11MToon?.outlineColorFactor?.count, 3)
        XCTAssertEqual(material11MToon?.outlineColorFactor?[0], 0)
        XCTAssertEqual(material11MToon?.outlineColorFactor?[1], 0)
        XCTAssertEqual(material11MToon?.outlineColorFactor?[2], 0)
        ...
        XCTAssertEqual(material11MToon?.parametricRimColorFactor?[0], 0)
        XCTAssertEqual(material11MToon?.parametricRimColorFactor?[1], 0)
        XCTAssertEqual(material11MToon?.parametricRimColorFactor?[2], 0)
        ...
        XCTAssertEqual(material11MToon?.shadeColorFactor?[0], 1)
        XCTAssertEqual(material11MToon?.shadeColorFactor?[1], 1)
        XCTAssertEqual(material11MToon?.shadeColorFactor?[2], 1)
    ...
    func testNodeConstraint() {
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[14].extensions?.nodeConstraint?.constraint.rotation?.source, 82)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[14].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[14].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[15].extensions?.nodeConstraint?.constraint.rotation?.source, 83)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[15].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[15].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[16].extensions?.nodeConstraint?.constraint.rotation?.source, 84)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[16].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[16].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[17].extensions?.nodeConstraint?.constraint.rotation?.source, 86)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[17].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[17].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[18].extensions?.nodeConstraint?.constraint.rotation?.source, 87)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[18].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[18].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[19].extensions?.nodeConstraint?.constraint.rotation?.source, 88)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[19].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[19].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[20].extensions?.nodeConstraint?.constraint.rotation?.source, 89)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[20].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[20].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[21].extensions?.nodeConstraint?.constraint.rotation?.source, 90)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[21].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[21].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[22].extensions?.nodeConstraint?.constraint.rotation?.source, 91)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[22].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[22].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[23].extensions?.nodeConstraint?.constraint.rotation?.source, 92)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[23].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[23].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[24].extensions?.nodeConstraint?.constraint.rotation?.source, 93)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[24].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[24].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[25].extensions?.nodeConstraint?.constraint.rotation?.source, 94)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[25].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[25].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[26].extensions?.nodeConstraint?.constraint.rotation?.source, 95)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[26].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[26].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[27].extensions?.nodeConstraint?.constraint.rotation?.source, 96)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[27].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[27].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[28].extensions?.nodeConstraint?.constraint.rotation?.source, 97)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[28].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[28].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[29].extensions?.nodeConstraint?.constraint.rotation?.source, 98)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[29].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[29].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[30].extensions?.nodeConstraint?.constraint.rotation?.source, 99)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[30].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[30].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[31].extensions?.nodeConstraint?.constraint.rotation?.source, 100)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[31].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[31].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[32].extensions?.nodeConstraint?.constraint.rotation?.source, 101)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[32].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[32].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[33].extensions?.nodeConstraint?.constraint.rotation?.source, 102)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[33].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[33].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[34].extensions?.nodeConstraint?.constraint.rotation?.source, 103)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[34].extensions?.nodeConstraint?.constraint.rotation?.weight, 1)
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[34].extensions?.nodeConstraint?.specVersion, "1.0")
        XCTAssertEqual(vrm.gltf.jsonData.nodes?[35].extensions?.nodeConstraint?.constraint.rotation?.source, 104)
